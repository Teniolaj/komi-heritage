      ...
      <main className="flex h-screen w-full">
        <section className="hidden lg:block lg:w-1/2 relative overflow-hidden">
          ...
          <div className="absolute bottom-12 left-12 right-12 z-20">
            <span className="font-dm-sans text-secondary-fixed font-bold tracking-[0.2em] uppercase mb-2 block text-xs">
              The Living Archive
            </span>
            ...
            <div className="mt-6 w-12 h-1 bg-secondary-container" />
          </div>
        </section>
        ...
        <section className="w-full lg:w-1/2 bg-[#fcf9f4] flex flex-col items-center justify-center relative px-6 md:px-12 py-12 md:py-24 overflow-y-auto min-h-screen">
          <div className="w-full max-w-md flex flex-col items-center mb-10 mt-8 lg:mt-0">
            ...
            <div className="flex w-full h-12 gap-1 mb-6 overflow-hidden opacity-90">
              <img
                className="flex-1 h-full object-cover grayscale hover:grayscale-0 transition-all duration-500"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuBT4a7ztClr7dudbv8HPG6JFrMepRLIApoVro9t808_YZnixGsGzh2fOYrdOhQs1odjYHpw3t8hVuU1LIZuOND08TH-8--95f2XS8CS79pfecU1lxffA-ks20S8Vjbum1FLy_h-arVeYEoN4zsWuKj5Mvf7UuIIo7i9LaNr56zBCE_LXKZSHeEbW_RubNf4xrfzaaNxb2Ypgso4jwke9J7RXdQyy_aAxDI-9LoBqt5Sy7t1UZxT8_Yf5Em6V3jqdkP0rUmgh6mT5j8"
                alt="Pepper Sauce"
              />
              <img
                className="flex-1 h-full object-cover grayscale hover:grayscale-0 transition-all duration-500"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuDW4tW1HagtXg5cCzovFXaFKtG0f1YlhDmPoSWYQYuFfdhp-s3gHHoMxNLAYJ0jgByabVYqE2vC080NlOR03vas1EEF829FsK8mOlJITI228mTpdmaYRBPjsP8xfEwcMf-kf-mOSq98nJ0CTe8nHERGYqpfqWnfr_Zcn7pFvDZGd2J9Bpuhom32FkdvNRuuyXDJLpVLRVARXHaKe6k-DWUsaziLxaK51i6QL5AMg_X1KTwt2uvaz8C6J3V6VwKSGjozoAzRM7r93Vg"
                alt="Heritage Texture"
              />
              <img
                className="flex-1 h-full object-cover grayscale hover:grayscale-0 transition-all duration-500"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuBLxUcqpzBffFmsQX3W2WhOho_nt8cSza1NIi1O5E3Z0_WD2FPWRl36txqI8mrmBAD0v-q6mno5CrdOcSThCQWD0usePj3-oRlG-wa1ff6Wm0vsW9OgpR2Z6C2wSmorZndMGpy3eX-0eJefpCxrGx4s5JYc0tVT2C2c7N6J_QoWviijgRDvSM_g1bCZ3Lr0uXEhpoxntVqpvHI_mINOzZLfT_uSEiyUL9BKQncsjrhdGE2Okj31DTtil1JP4n7rDZGYkPTBN_uTw-U"
                alt="Golden Fish"
              />
            </div>
          </div>
          ...
          <div className="w-full max-w-md bg-white border border-outline-variant/15 p-8 md:p-10 shadow-sm">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div className="relative group">
                <label className="block text-[10px] font-dm-sans uppercase tracking-widest font-bold text-secondary mb-1">
                  Email Address
                </label>
                <input
              ...
              <div className="relative group">
                <div className="flex justify-between items-end mb-1 font-dm-sans">
                  <label className="block text-[10px] uppercase tracking-widest font-bold text-secondary">
                    Password
                  </label>
                  <Link
                    href="/forgot"
                    className="text-[10px] font-bold text-primary hover:text-primary-container transition-colors uppercase tracking-widest"
                  >
                    Forgot password?
                  </Link>
                </div>
              ...
              <PrimaryButton
                type="submit"
                disabled={formLoading}
                className="w-full py-4 uppercase tracking-[0.2em] font-dm-sans font-bold text-xs mt-4 shadow-xl shadow-primary-container/20 border-0"
              >
                {formLoading ? (
            ...
            <div className="relative my-8 flex items-center">
              ...
              <span className="mx-4 text-[10px] uppercase tracking-widest font-bold text-on-surface-variant font-dm-sans">
                or
              </span>
              <div className="flex-grow border-t border-outline-variant/30" />
            </div>
            ...
            <div className="mt-8 text-center font-dm-sans">
              <p className="text-sm text-tertiary">
                New here?
                <Link
                  className="font-bold text-primary hover:underline underline-offset-4 ml-1 transition-all"
                  href="/signup"
                >
                  Create an account
                </Link>
